Gets rid of Description State so you are able to ask for multiple events in a row. Master branch from Amazon won't let you ask for another event without restarting the skill.
